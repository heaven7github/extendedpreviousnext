<?php
class Heaven7_Extendedpreviousnext_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
    ...
    public function getPreviousProduct()
    {
        ...
        if (method_exists(Mage::getResourceModel('catalog/category'), 'getProductsPosition')) {
    ...
    /**
     * @return Mage_Catalog_Model_Category or FALSE
     */
    public function getCategory()
    {

            $a = Mage::getModel('catalog/category')->load(Mage::registry('current_category')->getId());
            var_dump($a);
